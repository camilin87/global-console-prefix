    ...
    describe("when a prefix is specified", function(){
        ...
        describe("console.log", function(){
            it ("writes single string", function(){
                ...
                expect(captured_text).toBe("[INFO][GLOBAL] - something\n");
            });

            it ("does not write formatted string if format is not the first arg", function(){
                console.log("[SAMPLE]", "[%s]", "something");

                expect(captured_text).toBe("[INFO][GLOBAL] - [SAMPLE] [%s] something\n");
            });
            ...
            it ("writes multiple strings", function(){
                ...
                expect(captured_text).toBe("[INFO][GLOBAL] - something nothing\n");
            });

            it ("writes numbers", function(){
                console.log(1);

                expect(captured_text).toBe("[INFO][GLOBAL] - 1\n");
            });

            it ("writes multiple numbers", function(){
                console.log(1, 2, 3);

                expect(captured_text).toBe("[INFO][GLOBAL] - 1 2 3\n");
            });
            ...
            it ("writes objects", function(){
                ...
                expect(captured_text).toBe("[INFO][GLOBAL] - { name: 'pepe', weight: 12 }\n");
            });
            ...
            it ("writes multiple objects", function(){
                ...
                expect(captured_text).toBe(
                    "[INFO][GLOBAL] - { name: 'pepe', weight: 12 } { name: 'mom', weight: 1 }\n"
                );
            });
            ...
            it ("writes mixed contents", function(){
                ...
                expect(captured_text).toBe("[INFO][GLOBAL] - age 34 presenter { name: 'pepe', weight: 12 }\n");
            });
        });
        ...
        describe("console.warn", function(){
            it ("writes single string", function(){
                ...
                expect(captured_text).toBe("[ERROR][GLOBAL] - something\n");
            });

            it ("does not write formatted string if format is not the first arg", function(){
                console.warn("[SAMPLE]", "[%s]", "something");

                expect(captured_text).toBe("[ERROR][GLOBAL] - [SAMPLE] [%s] something\n");
            });
            ...
            it ("writes multiple strings", function(){
                ...
                expect(captured_text).toBe("[ERROR][GLOBAL] - something nothing\n");
            });

            it ("writes numbers", function(){
                console.warn(1);

                expect(captured_text).toBe("[ERROR][GLOBAL] - 1\n");
            });

            it ("writes multiple numbers", function(){
                console.warn(1, 2, 3);

                expect(captured_text).toBe("[ERROR][GLOBAL] - 1 2 3\n");
            });
            ...
            it ("writes objects", function(){
                ...
                expect(captured_text).toBe("[ERROR][GLOBAL] - { name: 'pepe', weight: 12 }\n");
            });
            ...
            it ("writes multiple objects", function(){
                ...
                expect(captured_text).toBe(
                    "[ERROR][GLOBAL] - { name: 'pepe', weight: 12 } { name: 'mom', weight: 1 }\n"
                );
            });
            ...
            it ("writes mixed contents", function(){
                ...
                expect(captured_text).toBe("[ERROR][GLOBAL] - age 34 presenter { name: 'pepe', weight: 12 }\n");
            });
        });
        ...
        describe("console.trace", function(){
            it ("writes single string", function(){
                ...
                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: something\n");
            });

            it ("does not write formatted string if format is not the first arg", function(){
                console.trace("[SAMPLE]", "[%s]", "something");

                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: [SAMPLE] [%s] something\n");
            });
            ...
            it ("writes multiple strings", function(){
                ...
                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: something nothing\n");
            });

            it ("writes numbers", function(){
                console.trace(1);

                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: 1\n");
            });

            it ("writes multiple numbers", function(){
                console.trace(1, 2, 3);

                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: 1 2 3\n");
            });
            ...
            it ("writes objects", function(){
                ...
                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: { name: 'pepe', weight: 12 }\n");
            });
            ...
            it ("writes multiple objects", function(){
                ...
                expect(captured_text).toContain(
                    "[ERROR][GLOBAL] - Trace: { name: 'pepe', weight: 12 } { name: 'mom', weight: 1 }\n"
                );
            });
            ...
            it ("writes mixed contents", function(){
                ...
                expect(captured_text).toContain("[ERROR][GLOBAL] - Trace: age 34 presenter { name: 'pepe', weight: 12 }\n");
            });
        });
    });
});